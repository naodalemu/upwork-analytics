...
export const metadata: Metadata = {
  ...
  description: 'Transform your Upwork transaction data into actionable insights. Upload your CSV file and discover comprehensive analytics about your income performance.',
  keywords: ['Upwork', 'Income Dashboard', 'CSV Upload', 'Income Analytics', 'Freelance Dashboard'],
  authors: [{ name: 'Naod', url: 'https://www.upwork.com/freelancers/~01cb9ac80cc3e1114e?mp_source=share' }],
  openGraph: {
    title: 'Upwork Income Analytics Dashboard',
    description: 'Transform your Upwork transaction data into actionable insights. Upload your CSV file and discover comprehensive analytics about your income performance.',
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body>{children}<GoogleAnalytics gaId="G-EMZ5EGH8N2" /></body>
    </html>
  )
}
